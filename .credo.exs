    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          # Every module this project wrote carries a real moduledoc; these are the
          # Phoenix scaffold, where a stub doc would be noise pretending to be care.
          {Credo.Check.Readability.ModuleDoc,
           [
             ignore_names: [
               ~r/^EstoqueOS\.(Repo|Mailer)$/,
               ~r/^EstoqueOSWeb\.(Router|Endpoint|Telemetry|UserAuth)$/,
               ~r/^EstoqueOSWeb\.UserSessionController$/,
               ~r/^EstoqueOSWeb\.UserLive\./,
               ~r/UserNotifier$/
             ]
           ]},
